...
<tr>
   ...
   <tr>
      <td height="24" colspan="4" class="bline">
        ...
        <tbody>
          <tr>
          <td width="90px">字段列表</td>
          <td width="240"><input name="count_field" class="option" type="text" id="countfield" style="width:160px" value="多个字段以空格隔开" size="16">
